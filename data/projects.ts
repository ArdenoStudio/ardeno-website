...
export const PROJECTS: Project[] = [
  ...
  },
  {
    id: "lankawa",
    title: "Lankawa",
    category: "Travel & Experience Intelligence",
    image: "/images/lankawa.jpg",
    tags: ["Destination Data", "Trip Planner", "Experience Guide"],
    description:
      "A Sri Lankan travel, tourism, and destination intelligence platform featuring location guides, trip planning, district insights, and curated experiences.",
    status: "Ardeno platform",
    problem: "Travelers, tourists, and locals need authentic, data-backed guidance on Sri Lanka destinations, itineraries, and travel costs without navigating fragmented noise.",
    solution: "Designed an immersive travel intelligence console with interactive district guides, curated destination itineraries, real-time travel insights, and smart trip planning.",
