    ...
    return (
        <AnimatePresence>
            {visible && (
                ...
                >
                    <div
                        className="relative w-full max-w-[760px] rounded-[22px] md:rounded-[26px] border px-5 py-4 md:px-7 md:py-6"
                        style={{
                            ...
                            boxShadow:
                                "0 20px 60px rgba(0,0,0,0.6), 0 0 0 1px rgba(229,9,20,0.05)",
                        }}
                    >
                        <div
                        ...
                        <div className="relative flex flex-col gap-3 md:gap-4 md:flex-row md:items-end md:justify-between">
                            <div className="max-w-md">
                                <div className="mb-2 flex items-center gap-2">
                                    ...
                                    />
                                    <span className="text-[9px] md:text-[10px] font-semibold uppercase tracking-[0.25em] md:tracking-[0.28em] text-zinc-400">
                                        Cookie Preferences
                                    </span>
                                </div>

                                <h3
                                    className="text-[1.5rem] md:text-[1.9rem] leading-none tracking-[-0.03em] text-white"
                                ...
                                <p
                                    className="mt-1.5 md:mt-2 text-[12px] md:text-[13px] leading-relaxed md:leading-6 text-zinc-400"
                                    style={{
                                ...
                                >
                                    ...
                                    cookies to understand traffic and improve performance.
                                </p>
                            </div>
