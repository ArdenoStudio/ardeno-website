...
export const Footer: React.FC<FooterProps> = ({ onOpenContact }) => {
  ...
  // WhatsApp links move up to top level
  ...
  return (
    <footer id="contact" className="relative bg-[#080809] overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 pt-20 md:pt-28 pb-20">
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-0">
          ...
          <motion.div
            ...
            className="grid grid-cols-1 sm:grid-cols-2 gap-y-16 sm:gap-12 lg:gap-20 lg:pt-2 text-left"
          >
            {/* Explore */}
            <div>
              <p
      ...
      <div className="container mx-auto px-6 md:px-12 py-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 md:gap-4">
        <span
          className="text-[11px] text-zinc-500 tracking-[0.18em] uppercase text-left"
          style={{ fontFamily: FONT_B }}
        >
